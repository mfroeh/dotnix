...
nix-shell -p git
git clone https://github.com/mfroeh/dotnix dotnix && cd dotnix && nix build .#darwinConfigurations.$1.system --extra-experimental-features "nix-command flakes" && ./result/sw/bin/darwin-rebuild switch .#$1 && cd $HOME
exit
